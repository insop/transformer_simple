...
def go(arg):
    ...
    if arg.final:
        ...
        train, test, valid = tdata.split(split_ratio=[0.01, 0.98, 0.01])
...
if __name__ == "__main__":
    ...
    parser.add_argument("-t", "--tiny", dest="tiny",
                        help="Whether to run on the tiny data set for code debugging.",
                        action="store_true")
